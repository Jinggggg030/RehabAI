...
| 9 | Lateral Step Down | Front view; hips, both knees, both ankles and step visible | Upright on the step with the supporting leg extended | Supporting knee bends as the free foot lowers toward the floor | Hips, knees, ankles | Medium/high: front view supports knee-tracking checks while hip drop drives rep detection |
