            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  const SizedBox(width: 40), // Empty placeholder to balance header
                ],
              ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Icon(Icons.home_outlined, color: Color(0xFFD34F70), size: 24),
                    ...
                    GestureDetector(
                      ...
                      child: Row(
                        children: [
                          const Icon(Icons.phone_outlined, color: Color(0xFFD34F70), size: 24),
                          const SizedBox(width: 16),
                          Text(
                            '06-2292308',
                            style: GoogleFonts.readexPro(
                    ...
                    // Email Address
                    GestureDetector(
                      onTap: () => _launchUrl('mailto:pusatkesihatanutem@utem.edu.my'),
                      child: Row(
                        children: [
                          const Icon(Icons.email_outlined, color: Color(0xFFD34F70), size: 24),
                          const SizedBox(width: 16),
                          Flexible(
                            child: Text(
